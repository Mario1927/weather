      ...
      <div className="w-full h-full flex flex-col justify-center items-center">
        <div className="w-full h-[95vh] flex items-center justify-between">
            <div className='border-2 flex items-center justify-center w-full md:w-[50%] lg:w-[33%] xl:w-[25%]'>
                <img src={Weather1} alt="weather" className="w-full h-[90vh] block mx-auto"/>
            </div>
            <div className='hidden md:flex md:w-[50%] lg:w-[33%] xl:w-[25%] border-2'>
                <img src={Weather2} alt="weather" className="w-full h-[90vh] block mx-auto"/>
            </div>
            <div className='hidden lg:flex lg:w-[33%] xl:[25%] border-2'>
                <img src={Weather3} alt="weather" className="w-full h-[90vh] block mx-auto"/>
            </div>
            <div className='hidden xl:flex xl:w-[25%] border-2'>
                <img src={Weather4} alt="weather" className="w-full h-[90vh] block mx-auto"/>
            </div>
        </div>
